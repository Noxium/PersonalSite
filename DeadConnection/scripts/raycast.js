// Shamelessly copy pasted from https://github.com/liabru/matter-js/issues/181#issuecomment-294319089
...
function raycast(bodies, start, end, sort = true){
	...
	if(sort)
		cols.sort(function(a,b){ return a.point.distance(start) - b.point.distance(start); });
